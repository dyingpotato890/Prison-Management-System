...
function VisitorDetails() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://prison-management-system-bmxy.onrender.com/visitors');
        ...
        <div className="App">
            ...
            {showModal && (
                <Modal onClose={handleCloseModal}>
                    {activeOperation === 'add' && <div><AddVisitor fetchData={fetchData}/></div>}
                    {activeOperation === 'delete' && <div><DeleteVisitor fetchData={fetchData}/></div>}
                </Modal>
            )}
        </div>
    );
